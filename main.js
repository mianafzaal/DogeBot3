...
const starts = async (DogeXeonOP = new WAConnection()) => {
	...
	console.log(color('\n> YT CHANNEL: 𝐀𝐑𝐂𝐓𝐈𝐗 ','silver'))
console.log(color('> GITHUB: Sibuuuu07 ','silver'))
console.log(color('> WA NUMBER: +919337956084 ','silver'))
console.log(color('  Sibu Bot Inc. 2022','mediumseagreen'))
    ...
    console.log(color('[𝐀𝐑𝐂𝐓𝐈𝐗 𝐁𝐎𝐓]'), color('𝐀𝐑𝐂𝐓𝐈𝐗 𝐁𝐎𝐓 Is Online', 'aqua'))
    console.log(color('[DEV]', 'cyan'), color('Welcome Back Owner! Hope You Doing Well~', 'magenta'))
    console.log(color('<>','red'), color('Thanks For Using 𝐀𝐑𝐂𝐓𝐈𝐗 𝐁𝐎𝐓', 'white'))
	DogeXeonOP.browserDescription = [ 'Subscribe 𝐀𝐑𝐂𝐓𝐈𝐗', 'chrome', '3.0' ]
    DogeXeonOP.on('qr', () => {
